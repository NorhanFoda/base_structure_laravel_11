            ...
            <el-form label-position="top">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <FormInput label="messages.name" :model="resource" name="name_en"
                                           :errors="errors.value"/>
                            </div>
                            <div class="col-md-4">
                                <FormInput label="messages.name_ar" :model="resource" name="name_ar"
                                           :errors="errors.value"/>
                            </div>
                            <div class="col-md-4">
                                <FormInput label="messages.email" :model="resource" name="email"
                                           :errors="errors.value"/>
                            </div>
                            <div class="col-md-4">
                                <FormInput label="messages.phone" type="number" :model="resource"
                                           name="phone" :errors="errors.value"/>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <FormSwitcher title="messages.active" :model="resource" name="is_active"
                                              :errors="errors.value"/>
                            </div>
                        </div>
                        <div class="row mt-3">
