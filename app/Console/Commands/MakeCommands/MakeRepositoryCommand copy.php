...
class MakeRepositoryCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:repo {modelName} {--options=} {--namespace=} {--web} {--api} {--mobile} {--vue} {--middleware=}';
    /**
    ...
    namespace & api are optional params for web / api controllers & requests and vuejs';
